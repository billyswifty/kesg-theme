...
if(function_exists('wpsass_define_stylesheet')) {
        wpsass_define_stylesheet("customstyle.scss");
        wpsass_define_stylesheet("custom-woocommerce.scss");
...
add_action('admin_head', 'change_bg');
...
function html5blank_header_scripts()
{
    if ($GLOBALS['pagenow'] != 'wp-login.php' && !is_admin()) {
        ...
        wp_register_script('swipe', get_template_directory_uri() . '/js/swipe.js', array('jquery'), '1.0.0'); // Custom scripts
        wp_enqueue_script('swipe'); // Enqueue it!
...
{
    global $post;
    return '... <a class="view-article btn" href="' . get_permalink($post->ID) . '">' . __('Read More', 'html5blank') . '</a>';
}
